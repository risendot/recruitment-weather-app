var app = angular.module('weatherApp', ['ngMaterial', 'ngMessages', 'ngSanitize', 'ui.router'])
        ...
        .config(['$mdIconProvider', '$mdThemingProvider', '$sceDelegateProvider', '$mdAriaProvider', function ($mdIconProvider, $mdThemingProvider, $sceDelegateProvider, $mdAriaProvider) {
            $mdIconProvider
